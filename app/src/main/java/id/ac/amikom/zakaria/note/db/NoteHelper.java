package id.ac.amikom.zakaria.note.db;
...
import id.ac.amikom.zakaria.note.model.Note;

import java.util.ArrayList;

import static android.provider.BaseColumns._ID;
import static id.ac.amikom.zakaria.note.db.DatabaseContract.*;
import static id.ac.amikom.zakaria.note.db.DatabaseContract.NoteColumns.*;
import static id.ac.amikom.zakaria.note.db.DatabaseContract.NoteColumns.DATE;
import static id.ac.amikom.zakaria.note.db.DatabaseContract.NoteColumns.DESCRIPTION;
import static id.ac.amikom.zakaria.note.db.DatabaseContract.NoteColumns.TITLE;
import static id.ac.amikom.zakaria.note.db.DatabaseContract.TABLE_NOTE;
