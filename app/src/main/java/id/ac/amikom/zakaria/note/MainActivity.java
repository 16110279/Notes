package id.ac.amikom.zakaria.note;
...
import id.ac.amikom.zakaria.note.adapter.NoteAdapter;
import id.ac.amikom.zakaria.note.db.NoteHelper;
import id.ac.amikom.zakaria.note.model.Note;

import java.util.ArrayList;
import java.util.LinkedList;

import static id.ac.amikom.zakaria.note.FormAddUpdateActivity.REQUEST_UPDATE;
